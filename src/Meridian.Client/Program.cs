...
var apiBaseUrl = builder.Configuration["Api:BaseUrl"]
    ?? throw new InvalidOperationException(
        "Configuration value 'Api:BaseUrl' is missing.");
...
if (useLocalMode)
{
    ...
    // HttpClient points to Meridian.Api
...
else
{
    ...
    var apiScope = builder.Configuration["Api:Scope"]
        ?? throw new InvalidOperationException(
            "Configuration value 'Api:Scope' is missing.");
    ...
    {
        var handler =
            sp.GetRequiredService<ApiAuthorizationMessageHandler>();
